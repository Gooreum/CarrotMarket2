...
public class SellerTradingFragment extends Fragment implements SellerView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_seller_products_trading, container, false);
        ...
        presenter.getProductsTrading(nick,1);
    ...
    public void onGetResult(List<Product> products) {
        product = products;
        adapter = new SellerAdapter(getContext(), product, itemClickListener);
