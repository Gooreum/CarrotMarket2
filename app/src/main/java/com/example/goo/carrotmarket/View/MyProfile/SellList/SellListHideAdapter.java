...
public class SellListHideAdapter extends RecyclerView.Adapter<SellListHideAdapter.ViewHolder> {
    ...
    public SellListHideAdapter(Context mContext, List<Product> listItems, ItemClickListener itemClickListener) {
