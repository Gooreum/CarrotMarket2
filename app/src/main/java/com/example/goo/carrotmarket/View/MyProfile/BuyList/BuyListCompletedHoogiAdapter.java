...
public class BuyListCompletedHoogiAdapter extends RecyclerView.Adapter<BuyListCompletedHoogiAdapter.ViewHolder> {
    ...
    public BuyListCompletedHoogiAdapter(Context mContext, List<Product> listItems, ItemClickListener productListener, ItemClickListener hoogiListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_completed_hoogi, parent, false);
