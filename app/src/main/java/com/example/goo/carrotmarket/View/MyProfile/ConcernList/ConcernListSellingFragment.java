...
public class ConcernListSellingFragment extends Fragment implements ConcernListView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_concern_selling, container, false);
    ...
    public void onGetResult(List<Product> products) {
        adapter = new ConcernListAdapter(getContext(), products, itemClickListener);
