...
public class ChatListRealTimeAdapter extends RecyclerView.Adapter<ChatListRealTimeAdapter.ViewHolder> {
    ...
    public ChatListRealTimeAdapter(Context mContext, List<Chat> listItems, ItemClickListener itemClickListener) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.txt_date.setText(chat.getDate().toString());
